...
import 'package:marketplace/ui/screens/new_screens/web/warung_panen_public/widgets/tracking/wpp_list_order_tracking_item.dart';
...
class WppTransaksiStatusPesananScreen extends StatefulWidget {
  ...
  const WppTransaksiStatusPesananScreen({Key key, this.orderId}) : super(key: key);
...
class _WppTransaksiStatusPesananScreenState
  ...
  @override
  void initState() {
    _fetchTransactionTrackingCubit = FetchTransactionTrackingCubit()..getTrackingOrderNoAuth(orderId: widget.orderId);
    super.initState();
  }
                              ...
                              children: [
                                ...
                                ListView.separated(
                                  ...
                                  itemBuilder: (context,index){
                                    ...
                                    return WppListOrderTrackingItem(trackingOrderLogs: data,isStatused: index == 0,);
                                  }, 
                                )
