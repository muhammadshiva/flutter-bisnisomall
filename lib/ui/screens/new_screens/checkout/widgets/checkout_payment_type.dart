...
class CheckoutPaymentType extends StatefulWidget {
  const CheckoutPaymentType({Key key}) : super(key: key);

  @override
  _CheckoutPaymentTypeState createState() => _CheckoutPaymentTypeState();
}

class _CheckoutPaymentTypeState extends State<CheckoutPaymentType> {
